...
import com.think.awhealth.ui.base.BaseActivity;
...
public class RegisterActivity extends ToolBarActivity implements RegisterContract.View {
    ...
    private void attempRegister() {
        ...
        if (!UserInputVerification.isPasswordValid(password)) {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            cancel = true;
        } else if (!UserInputVerification.isEmailValid(email)) {
        ...
        if (cancel) {
            ...
            mRegisterPresenter.register(user,getBaseContext());
            showProgress(true);
        }
    }
    ...
    public void registerFailed(int meesageId, String message) {
        showProgress(false);
        Toast.makeText(getBaseContext(),UserMessageIdHelp.caseId(meesageId),Toast.LENGTH_SHORT).show();
        Log.w("logger","id"+meesageId+"\nmessage:"+message);
    }
